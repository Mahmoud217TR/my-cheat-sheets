...
* [Git Configs & Aliases](/git/config.md)
    * [Configs](/git/config.md#configs)
    * [Get & Set](/git/config.md#get--set-config)
    * [Configs in Editor](/git/config.md#configs)
    * [Aliases](/git/config.md#aliases)

* [Stashing](/git/stash.md)
    * [Stashing](/git/stash.md#stashing)
    * [Stash Lists](/git/stash.md#stash-lists)
